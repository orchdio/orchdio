...
func (p *Platforms) FetchPlatformAlbums(ctx *fiber.Ctx) error {
	...
	//	}
	//
	//	deezerService := deezer.NewService(&deezerCredentials, p.DB, p.Redis, app, webhookSender)
	...
	return util.ErrorResponse(ctx, fiber.StatusNotImplemented, "not implemented", "not implemented")
}
